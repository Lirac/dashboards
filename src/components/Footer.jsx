  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        <img src={logoWhite} alt="Dashboard" className="w-[266px] h-[72px] object-contain" />
        <p className={`${styles.paragraph} mt-4 max-w-[310px] text-[16px]`}>Streamlining your business and accelerating your processes through technology.</p>
      </div>
    ...
    <div className="w-full justify-between flex items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]">
      <div>
        <p className="font-poppins font-normal text-center text-[16px] leading-[27px] text-white">2023 DashBoards. All Rights Reserved.</p>
      </div>
